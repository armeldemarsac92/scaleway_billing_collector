...
The collector is Prometheus-first: it starts collecting live month-to-date snapshots when the pod starts, accumulates interval deltas in SQLite, and exposes cumulative counters from those live deltas. It does not backfill older months.
